...
public class frag9 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        list.add(new Item("BIZ SUTRA", R.drawable.bizquiz));
        list.add(new Item("EVERYTHING E QUIZ", R.drawable.e_quiz));
        list.add(new Item("SLAM QUIZ", R.drawable.slamquiz));
        list.add(new Item("JASHN-E-INDIA QUIZ", R.drawable.themequiz));
        ...
        rv.addOnItemTouchListener(
                new RecyclerTouchListener(getActivity(), rv, new ClickListener() {
                    ...
                    public void onClick(View v, int position) {
                        ...
                        if (MainActivity.st.peek() != (new frag9()))
                            MainActivity.st.push(new frag9());
                        switch (position) {
                            case 0:
                                Home_frag.img = R.drawable.bizquiz;
                                Home_frag.title = "Biz Sutra";
                                break;
                            case 1:
                                Home_frag.img = R.drawable.e_quiz;
                                Home_frag.title = "Everything E Quiz";
                                break;
                            case 2:
                                Home_frag.img = R.drawable.slamquiz;
                                Home_frag.title = "Slam Quiz";
                                break;
                            case 3:
                                Home_frag.img = R.drawable.themequiz;
                                Home_frag.title = "Jashn-E-India Quiz";
                                break;
                        }
