...
public class frag5 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        list.add(new Item("FOOT-LOOSE", R.drawable.solo));
        list.add(new Item("DANCING DUO", R.drawable.duet));
        list.add(new Item("SHAKE ON BEAT", R.drawable.instant));
        ...
        rv.addOnItemTouchListener(
                new RecyclerTouchListener(getActivity(), rv, new ClickListener() {
                    ...
                    public void onClick(View v, int position) {
                        ...
                        if (MainActivity.st.peek() != (new frag5()))
                            MainActivity.st.push(new frag5());
                        switch (position) {
                            case 0:
                                Home_frag.img = R.drawable.solo;
                                Home_frag.title = "Foot Loose";
                                break;
                            case 1:
                                Home_frag.img = R.drawable.duet;
                                Home_frag.title = "Dancing Duo";
                                break;
                            case 2:
                                Home_frag.img = R.drawable.instant;
                                Home_frag.title = "Shake on Beat";
                                break;
                        }
